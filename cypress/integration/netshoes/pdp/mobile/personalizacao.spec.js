describe('Teste E2E PDP - Netshoes HMG Mobile', () => {

    context('Personalização de chuteira - Mobile', function () {
  
      beforeEach(() => {
        cy.visit('http://hmg-netshoes-com-br.ns2online.com.br/chuteira-futsal-umbro-stratus-pro-preto+verde+limao-D21-0690-048')
      })
    
      it('Pé esquerdo e direito - Mobile', () => {
