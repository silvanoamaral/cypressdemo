describe('Teste E2E Search', () => {
    context('Search Desktop', () => {
      ...
      it('Validar Wishlist Response API', () => {
        ...
        cy.request('https://hmg-zattini-com-br.ns2online.com.br/wishlist/add/V54-0122-219')
        .should((response) => {
          expect(response.body).to.equal(true)
        })
  
        cy.request('https://hmg-zattini-com-br.ns2online.com.br/wishlist/delete/V54-0122-219')
        .should((response) => {
      ...
      it('Validar QuickView - seletor cor/tamanho/sabor, preço, imagem, nome do produto', () => {
        ...
        cy.get('.is-quickview .product-sku-selector .reference span').first().then(($sku) => {
          ...
          cy.get('.is-quickview .showcase h1').then(($productName) => {
            expect($productName.text()).to.include('Sapatilha Somoda Verniz Feminina')
          })
      ...
      it('Validar QuickView - link para a PDP', () => {
        ...
        cy.location('pathname').should('eq', '/sapatilha-somoda-verniz-feminina-nude-O14-0092-203')
      })
